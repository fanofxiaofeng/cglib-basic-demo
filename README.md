...
public class IntegerCalculator$$EnhancerByCGLIB$$ae52e4a0 extends IntegerCalculator implements Factory {
    ...
    static void CGLIB$STATICHOOK1() {
        Class var0 = Class.forName("com.demo.cg.IntegerCalculator$$EnhancerByCGLIB$$ae52e4a0");
        Class var1;
        Method[] var10000 = ReflectUtils.findMethods(new String[]{"equals", "(Ljava/lang/Object;)Z", "toString", "()Ljava/lang/String;", "hashCode", "()I", "clone", "()Ljava/lang/Object;"}, (var1 = Class.forName("java.lang.Object")).getDeclaredMethods());
        var10000 = ReflectUtils.findMethods(new String[]{"multiply", "(II)I", "div", "(II)I", "minus", "(II)I", "add", "(II)I"}, (var1 = Class.forName("com.demo.cg.IntegerCalculator")).getDeclaredMethods());
...
Since we have observed the console output in ![result](pic/result.png).
...
Since I have read some materials from [深入理解JVM字节码 9.1 cglib动态代理原理分析](),
...
each method `m` signature will be converted to a corresponding integer (just call it `num(m)` here).
